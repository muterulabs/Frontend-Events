function Header() {
  return (
    <header className="sticky top-0 z-40 w-full border-b dark:border-white/10 border-white/5 bg-black/70 glass">
        ...
        <div className="flex items-center gap-3 py-3 md:py-4">
          ...
          <a href="#" className="flex items-center gap-2 group">
            <div className="h-8 w-8 rounded-xl bg-[#0066FF] grid place-content-center text-black">
              <span className="text-[13px] font-semibold tracking-tight">Au</span>
            </div>
          ...
          <div className="relative flex-1 max-w-xl mx-auto">
            <div className="flex items-center gap-2 bg-[#F2F2F2] dark:bg-white/5 rounded-full pl-4 pr-3 py-2">
              <span className="w-4 h-4 dark:text-white/50 text-white/50">S</span> {/* Icon Placeholder */}
              <input
                type="text"
